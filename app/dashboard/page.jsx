...
import { MessageSquare, Flame, ArrowUpRight, Loader2 } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const { user, arc, checkInsMap, reviews, loading, saveCheckIn, saveReview } = useArc();
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 flex flex-col selection:bg-[#FF4500] selection:text-white font-sans">
      {/* Header stays mounted at all times */}
      <Navbar
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10 w-full">
        {loading ? (
          <div className="py-20 flex flex-col items-center justify-center gap-3 text-zinc-400 font-mono-code text-xs">
            ...
            <span>Loading Arc 90 Dashboard...</span>
          </div>
        ) : (
          <>
            {/* HERO PROGRESS CARD */}
